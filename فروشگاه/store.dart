  ...
  ''');
    ...
    try {
      ...
      if (input == 6) {
        ...
        print(
            "select the desired product number to remove from the list \n (enter 0 to cancel)");
        Store.show_products_list(allProducts);
        ...
        if (deleteItem != 0) {
          for (int k = 0; k < allProducts.length; k++) {
            if (deleteItem - 1 == k) {
              print(
                  "${allProducts[deleteItem - 1]} was successfully deleted.\n ------------------------------------");
        ...
        print(
            "select the desired product number to edit from the list \n (enter 0 to cancel)\n ");
        Store.show_products_list(allProducts);
        ...
        if (editItem != 0) {
          for (int j = 0; j <= allProducts.length; j++) {
            if (editItem == j) {
              ...
              print(
                  "enter new price of product : just enter number (cancel=> enter 0 ) \n  ");
              ...
              print(
                  "enter new number of product : just enter number   (cancel=> enter 0 ) \n  ");
        ...
        while (true) {
          ...
          if (nameOfProduct.isEmpty) {
            print(
                "**** name of product cannot be empty. Please enter a valid String. ***\n -----------------------------");
            continue;
          }

          print(
              "enter price of product : just enter number ( cancel => enter 0 )  ");
          ...
          print(
              "enter number of product :  just enter number  ( cancel => enter 0 )  ");
  ...
  static void show_limited_products(List<Product> my_allProducts) {
    ...
    for (int x = 0; x < my_allProducts.length; x++) {
      if (my_allProducts[x].numberOfProduct < 10) {
        limitedProducts.add(my_allProducts[x]);
      }
    }
    for (int z = 0; z < limitedProducts.length; z++) {
      print("${z + 1} _ ${limitedProducts[z]}");
    }
